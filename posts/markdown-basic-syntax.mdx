...
纯链接：<a href="https://www.silinchen.com" />
...
```markdown
图片：![markdown](http://localhost:3000/post-images/markdown-basic-syntax/i-love-markdown.jpg "i love markdown")
带链接的图片：[![markdown](http://localhost:3000/post-images/markdown-basic-syntax/i-love-markdown.jpg "i love markdown")](https://www.silinchen.com "markdown 语法大全")
```

HTML:

```html
<img src="http://localhost:3000/post-images/markdown-basic-syntax/i-love-markdown.jpg" width="200"/>
```
