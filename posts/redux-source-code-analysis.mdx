...
![redux-flow](http://localhost:3000/post-images/redux-source-code-analysis/redux-flow.png)
...
![redux state change](http://localhost:3000/post-images/redux-source-code-analysis/redux-state-change.png)
...
![](http://localhost:3000/post-images/redux-source-code-analysis/redux-with-middlewares.png)
...
![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-panel.png)
...
4. `Action` 可以查看当前 action 的详细内容
    ...
    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-action.png)

5. `State` 可以查看当前 state 数据的详细内容

    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-state.png)

6. `Diff` 可以查看当前 action 执行后，state 发生了哪些变化

    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-diff.png)

7. `Trace` 跟踪当前 action 执行的代码位置

    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-trace.png)

8. `Test` 测试模版

    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-test.png)
    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-toolbar.png)
...
15. 切换功能面板到 `Log monitor` 可以查看整个过程的日志
    ...
    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-log-monitor.png)

16. 切换功能面板到 `Chart` 可以查看整个 store 的状态

    ![](http://localhost:3000/post-images/redux-source-code-analysis/redux-devtools-chart.png)
