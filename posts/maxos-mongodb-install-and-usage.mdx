---
title: 'MAC OS 环境下的 MongoDB 安装与基本使用'
publishedAt: '2021-10-10'
summary: 'MAC OS 环境下的 MongoDB 安装与基本使用，安装报错解决'
---
...
![brew-install-mongodb-community](https://www.silinchen.com/post-images/maxos-mongodb-install-and-usage/brew-install-mongodb-community@4.2.png)
...
![image-20200420111150759](https://www.silinchen.com/post-images/maxos-mongodb-install-and-usage/create-user.png)
...
![image-20200417170520265](https://www.silinchen.com/post-images/maxos-mongodb-install-and-usage/error-fearuteCompatibilityVersion.png)
