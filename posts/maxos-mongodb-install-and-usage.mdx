...
![brew-install-mongodb-community](http://localhost:3000/post-images/maxos-mongodb-install-and-usage/brew-install-mongodb-community@4.2.png)
...
![image-20200420111150759](http://localhost:3000/post-images/maxos-mongodb-install-and-usage/create-user.png)
...
![image-20200417170520265](http://localhost:3000/post-images/maxos-mongodb-install-and-usage/error-fearuteCompatibilityVersion.png)
