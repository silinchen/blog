---
title: 'Flex 布局教程，前端必会的基础技能'
publishedAt: '2021-07-21'
summary: 'flex 是常用的 css3 布局方式，可以用少量的代码高效的实现各种页面布局，是一个基础的但是必须会的基本技能，在面试中经常会用到。'
---
### 前言
...
![](https://www.silinchen.com/post-images/css-flexible-box-layout/axis-detail.png)
...
![](https://www.silinchen.com/post-images/css-flexible-box-layout/axis.png)
...
![](https://www.silinchen.com/post-images/css-flexible-box-layout/flex-container.png)
...
![flex-direction-demo](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-fire-direction.png)
...
![demo-flex-wrap](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-wrap.png)
...
![demo-justify-content](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-justify-content.png)
...
![demo-flex-align-items](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-align-items.png)
...
![demo-flex-align-content](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-align-content.png)
...
![demo-flex-grow](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-grow.png)
...
![demo-felx-shrink](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-shrink.png)
...
![demo-flex-align-self](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-align-self1.png)
...
![demo-flex-order](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-flex-order.png)

### 五、小技巧

###### 1. 解决 flex 布局使用 `space-between` 两端对齐，最后一行不对齐问题

![demo1-flex-justify-content-space-between](https://www.silinchen.com/post-images/css-flexible-box-layout/demo1-flex-justify-content-space-between.png)
...
![demo1-flex-justify-content-space-between](https://www.silinchen.com/post-images/css-flexible-box-layout/demo1-flex-justify-content-space-between1.png)
...
![demo-holy-grail-layout](https://www.silinchen.com/post-images/css-flexible-box-layout/demo-holy-grail-layout.png)

参考文档：MDN flex 布局文档

![](https://www.silinchen.com/post-images/css-flexible-box-layout/web-interview.png)
