...
![](http://localhost:3000/post-images/css-flexible-box-layout/axis-detail.png)
...
![](http://localhost:3000/post-images/css-flexible-box-layout/axis.png)
...
![](http://localhost:3000/post-images/css-flexible-box-layout/flex-container.png)
...
![flex-direction-demo](http://localhost:3000/post-images/css-flexible-box-layout/demo-fire-direction.png)
...
![demo-flex-wrap](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-wrap.png)
...
![demo-justify-content](http://localhost:3000/post-images/css-flexible-box-layout/demo-justify-content.png)
...
![demo-flex-align-items](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-align-items.png)
...
![demo-flex-align-content](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-align-content.png)
...
![demo-flex-grow](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-grow.png)
...
![demo-felx-shrink](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-shrink.png)
...
![demo-flex-align-self](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-align-self1.png)
...
![demo-flex-order](http://localhost:3000/post-images/css-flexible-box-layout/demo-flex-order.png)

### 五、小技巧

###### 1. 解决 flex 布局使用 `space-between` 两端对齐，最后一行不对齐问题

![demo1-flex-justify-content-space-between](http://localhost:3000/post-images/css-flexible-box-layout/demo1-flex-justify-content-space-between.png)
...
![demo1-flex-justify-content-space-between](http://localhost:3000/post-images/css-flexible-box-layout/demo1-flex-justify-content-space-between1.png)
...
![demo-holy-grail-layout](http://localhost:3000/post-images/css-flexible-box-layout/demo-holy-grail-layout.png)

参考文档：MDN flex 布局文档

![](http://localhost:3000/post-images/css-flexible-box-layout/web-interview.png)
