---
title: '从零实现一个简单的 Vue2.0 框架，掌握 MVVM 框架原理'
publishedAt: '2020-02-07'
summary: '从零实现一个简单的 Vue2.0 框架，掌握 MVVM 框架原理，掌握 Vue 双向绑定原理，加深对 vue 的理解。'
---
*--文末附视频教程*
...
![流程图](https://www.silinchen.com/post-images/learn-mvvm-implement-a-simple-vue/mvvm.png)
